        ...
        >
          <div class="p-4">
            <div class="flex items-start">
              <div class="shrink-0">
                <CheckCircleIcon v-if="isSuccess === true" class="size-6 text-green-400" aria-hidden="true" />
                <XCircleIcon v-if="isSuccess === false" class="size-6 text-red-400" aria-hidden="true" />
              </div>
